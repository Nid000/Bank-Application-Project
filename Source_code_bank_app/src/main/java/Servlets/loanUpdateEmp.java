...
/**
 * Servlet implementation class loanUpdateEmp
 */
@WebServlet("/LonDetUpdServlet")
public class loanUpdateEmp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public loanUpdateEmp() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("loanUpdateEmp.jsp").forward(request, response);
	}
