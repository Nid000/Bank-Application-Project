...
/**
 * Servlet implementation class cusdetailsUpdate
 */
@WebServlet("/cusUpdate")
public class cusdetailsUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public cusdetailsUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("CusdetailsUpdate.jsp").forward(request, response);
	}
