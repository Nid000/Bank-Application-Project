...
public class Home extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int total_loans = cd.getTloans();
		System.out.println("total loans is " + total_loans);
...
//			request.setAttribute("l_paid", lm.getL_paid());
//			request.setAttribute("l_balance", lm.getL_balance());
//			request.setAttribute("loan", "Reminder to make your payment for your loan balance.");
//			request.getRequestDispatcher("customerHome.jsp").forward(request, response);
//		}
		}
}
